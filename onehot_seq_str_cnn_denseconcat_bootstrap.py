...
#def MCNN(trainX1,trainX2,trainY1,valX1,valX2,valY1,input_1,input_2, i,class_weights,t):
#    if(t==0):
...
#        myjson_file = "myhist_" +"dict_" + "secstr_seq_denseconcat_60perc_" +str(i)
#        history_dict = fitHistory.history
#        json.dump(history_dict, open(myjson_file, 'a'))
#        return cnn, fitHistory
...
for i in range(10):
    ...
    for t in range(int(neg_pos_ratio)):
        ...
        cnn, fitHistory = bt.MCNN_best(trainX1,trainX2,trainY,ValX1,ValX2,ValY,input_1,input_2, i,class_weights,t)
#        cnn26,fitHistory26= bt.MCNN_26(trainX1,trainX2,trainY,ValX1,ValX2,ValY,input_1,input_2, i,class_weights,t)
    run_test_onehot(test_new,i,'balanced_test_hyperas_best')
    run_test_onehot(test,i,'imbalanced_test_hyperas_best')
    outfile_test = 'balanced_' + 'emboss_60perc_testing_' + str(i) +".txt"
    test_new.to_csv(outfile_test,sep='\t',index=False,header=False)
#%d-secstr_seq_denseconcat_60perc_best.h5
#%d-secstr_seq_denseconcat_trial26.h5
